-- Customer database: identity, accounts, devices, and customer transactions.
...
CREATE INDEX IF NOT EXISTS idx_customer_transactions_user_ts ON transactions(user_id, timestamp_unix_ms);
